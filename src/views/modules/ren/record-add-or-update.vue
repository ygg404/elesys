<template>
  <el-dialog width="80%"
    ...
    <!-- 教育经验 弹窗, 新增 / 修改 -->
    <recordeducation-add-or-update v-if="recordeductionVisible" ref="recordeductionAddOrUpdate"
                                   @refreshDataList="getDataList"></recordeducation-add-or-update>
    <!-- 工作履历 弹窗, 新增 / 修改 -->
    <recordwork-add-or-update v-if="recordworkVisible" ref="recordworkAddOrUpdate"
                              @refreshDataList="getDataList"></recordwork-add-or-update>
...
<script>
  ...
  export default {
    ...
    components: {
      recordeductionAddOrUpdate,
      recordworkAddOrUpdate
    },
    created() {
          ...
          if (this.dataForm.userId) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.headImg = window.atob(data.renRecordVo.headImg)
          ...
          if (valid) {
            ...
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'headImg': window.btoa(this.dataForm.headImg),
